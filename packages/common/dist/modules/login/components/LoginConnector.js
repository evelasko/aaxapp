...
exports.LoginConnector = function (_a) {
    ...
    return (react_1.default.createElement(LoginController_1.LoginController, null, function (_a) {
        ...
        return react_1.default.createElement(LoginView_1.LoginView, { submit: function (values) { return __awaiter(_this, void 0, void 0, function () {
                var res, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            res = _a.sent();
                            if (!(res.token && !res.error)) return [3 /*break*/, 6];
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
            ...
            }); }, handleForgot: handleForgot, handleSignUp: handleSignUp, handleGuest: handleGuest });
    }));
};
