...
var PolicyContentMD_1 = __importDefault(require("./PolicyContentMD"));
...
var PolicyContent = function () {
    return (react_1.default.createElement(react_native_1.ScrollView, { style: __assign({}, react_native_1.StyleSheet.absoluteFillObject, { margin: 30 }) },
        react_1.default.createElement(react_native_markdown_renderer_1.default, { rules: rules }, PolicyContentMD_1.default)));
};
exports.default = PolicyContent;
